<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinanceStatistics.aspx.cs" Inherits="FinanceStatistics" %>
...
<body>
    <form id="form1" runat="server" style="text-align: center;">
        ...
        <br />
        <asp:Label ID="lblHISTORY" runat="server" Text="Patient List - Grouped by HISTORY"></asp:Label>
        <br />
        <br />
        ...
        <br />
        <asp:Label ID="lblDate" runat="server" Text=" Patient List - Grouped by DATE"></asp:Label>
        <br />
        <br />
        ...
        <p>
            ...
            <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Dashboard" Width="185px" style="margin-left: 30px" />
        </p>
    </form>
</body>
</html>
